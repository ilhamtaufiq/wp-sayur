	...
	/*====== SHOP ====================================================================================*/
		...
		bacola_customizer_add_field (
			array(
				...
				'label' => esc_attr__( 'Added to Cart Ajax Notice', 'bacola' ),
				'description' => esc_attr__( 'You can choose status of the ajax notice feature.', 'bacola' ),
				'section' => 'bacola_shop_general_section',
				'default' => '0',
			)
		);
		...
		bacola_customizer_add_field (
			array(
				...
				'label' => esc_attr__( 'Order on WhatsApp', 'bacola' ),
		...
		bacola_customizer_add_field (
			array(
				...
				'label' => esc_attr__( 'WhatsApp Number', 'bacola' ),
	...
	/*====== Elementor Templates =======================================================*/
		...
		bacola_customizer_add_field (
			array(
				...
				'label'       => esc_html__( 'Before Shop Elementor Template', 'bacola' ),
				'section'     => 'bacola_elementor_templates_section',
				'default'     => '',
				'placeholder' => esc_html__( 'Select a template from elementor templates ', 'bacola' ),
		...
		bacola_customizer_add_field (
			array(
				...
				'label'       => esc_html__( 'After Shop Elementor Template', 'bacola' ),
				'section'     => 'bacola_elementor_templates_section',
				'default'     => '',
				'placeholder' => esc_html__( 'Select a template from elementor templates ', 'bacola' ),
				'choices'     => bacola_get_elementorTemplates('section'),
		...
		bacola_customizer_add_field (
			array(
				...
				'label'       => esc_html__( 'Before Header Elementor Template', 'bacola' ),
				'section'     => 'bacola_elementor_templates_section',
				'default'     => '',
				'placeholder' => esc_html__( 'Select a template from elementor templates, If you want to show any content before products ', 'bacola' ),
				'choices'     => bacola_get_elementorTemplates('section'),
		...
		bacola_customizer_add_field (
			array(
				...
				'label'       => esc_html__( 'After Header Elementor Template', 'bacola' ),
				'section'     => 'bacola_elementor_templates_section',
				'default'     => '',
				'placeholder' => esc_html__( 'Select a template from elementor templates ', 'bacola' ),
				'choices'     => bacola_get_elementorTemplates('section'),
		...
		bacola_customizer_add_field (
			array(
				...
				'label'       => esc_html__( 'Before Footer Elementor Template', 'bacola' ),
				'section'     => 'bacola_elementor_templates_section',
				'default'     => '',
				'placeholder' => esc_html__( 'Select a template from elementor templates, If you want to show any content before products ', 'bacola' ),
				'choices'     => bacola_get_elementorTemplates('section'),
		...
		bacola_customizer_add_field (
			array(
				...
				'label'       => esc_html__( 'After Footer Elementor Templates', 'bacola' ),
				'section'     => 'bacola_elementor_templates_section',
				'default'     => '',
				'placeholder' => esc_html__( 'Select a template from elementor templates, If you want to show any content before products ', 'bacola' ),
				'choices'     => bacola_get_elementorTemplates('section'),
