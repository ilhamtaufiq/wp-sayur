...
! defined( 'WOOSC_VERSION' ) && define( 'WOOSC_VERSION', '5.1.4' );
		...
		if ( ! class_exists( 'WPCleverWoosc' ) && class_exists( 'WC_Product' ) ) {
			class WPCleverWoosc {
				...
				function __construct() {
					...
					// ajax load data
					add_action( 'wp_ajax_woosc_load_data', array( $this, 'load_data' ) );
					add_action( 'wp_ajax_nopriv_woosc_load_data', array( $this, 'load_data' ) );
				...
				function enqueue_scripts() {
					...
					// notiny
					if ( get_option( 'woosc_button_action', 'show_table' ) === 'show_message' ) {
						wp_enqueue_style( 'notiny', WOOSC_URI . 'assets/libs/notiny/notiny.css' );
						wp_enqueue_script( 'notiny', WOOSC_URI . 'assets/libs/notiny/notiny.js', array( 'jquery' ), WOOSC_VERSION, true );
					}
					...
					wp_localize_script( 'woosc-frontend', 'woosc_vars', array(
							...
							'open_button'        => esc_attr( get_option( 'woosc_open_button', '' ) ),
							'open_button_action' => get_option( 'woosc_open_button_action', 'open_popup' ),
							'menu_action'        => get_option( 'woosc_menu_action', 'open_popup' ),
							'button_action'      => get_option( 'woosc_button_action', 'show_table' ),
							'sidebar_position'   => get_option( 'woosc_sidebar_position', 'right' ),
							'message_position'   => get_option( 'woosc_message_position', 'right-top' ),
				...
				function register_settings() {
					// settings
					register_setting( 'woosc_settings', 'woosc_open_button' );
					register_setting( 'woosc_settings', 'woosc_open_button_action' );
					register_setting( 'woosc_settings', 'woosc_button_type' );
					register_setting( 'woosc_settings', 'woosc_button_action' );
					register_setting( 'woosc_settings', 'woosc_message_position' );
					register_setting( 'woosc_settings', 'woosc_sidebar_position' );
					register_setting( 'woosc_settings', 'woosc_button_text_change' );
					register_setting( 'woosc_settings', 'woosc_button_class' );
					register_setting( 'woosc_settings', 'woosc_button_archive' );
					register_setting( 'woosc_settings', 'woosc_button_single' );
					register_setting( 'woosc_settings', 'woosc_open_bar_immediately' );
					register_setting( 'woosc_settings', 'woosc_hide_checkout' );
					register_setting( 'woosc_settings', 'woosc_click_again' );
					register_setting( 'woosc_settings', 'woosc_close_button' );
					register_setting( 'woosc_settings', 'woosc_hide_empty' );
					register_setting( 'woosc_settings', 'woosc_bar_bubble' );
					register_setting( 'woosc_settings', 'woosc_bar_share' );
					register_setting( 'woosc_settings', 'woosc_bar_add' );
					register_setting( 'woosc_settings', 'woosc_bar_remove' );
					register_setting( 'woosc_settings', 'woosc_bar_bg_color' );
					register_setting( 'woosc_settings', 'woosc_bar_btn_color' );
					register_setting( 'woosc_settings', 'woosc_bar_pos' );
					register_setting( 'woosc_settings', 'woosc_bar_align' );
					register_setting( 'woosc_settings', 'woosc_click_outside' );
					register_setting( 'woosc_settings', 'woosc_limit' );
					register_setting( 'woosc_settings', 'woosc_page_id' );
					register_setting( 'woosc_settings', 'woosc_fields' );
					register_setting( 'woosc_settings', 'woosc_attributes' );
					register_setting( 'woosc_settings', 'woosc_custom_attributes' );
					register_setting( 'woosc_settings', 'woosc_custom_fields' );
					register_setting( 'woosc_settings', 'woosc_image_size' );
					register_setting( 'woosc_settings', 'woosc_link' );
					register_setting( 'woosc_settings', 'woosc_table_settings' );
					register_setting( 'woosc_settings', 'woosc_remove' );
					register_setting( 'woosc_settings', 'woosc_freeze_column' );
					register_setting( 'woosc_settings', 'woosc_freeze_row' );
					register_setting( 'woosc_settings', 'woosc_perfect_scrollbar' );
					register_setting( 'woosc_settings', 'woosc_search_count' );
					register_setting( 'woosc_settings', 'woosc_search_cats' );
					register_setting( 'woosc_settings', 'woosc_menus' );
					register_setting( 'woosc_settings', 'woosc_menu_action' );
                                ...
                                <form method="post" action="options.php">
                                    <table class="form-table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="woosc_button_action">
                                                    <option value="show_bar" <?php echo esc_attr( get_option( 'woosc_button_action', 'show_table' ) === 'show_bar' ? 'selected' : '' ); ?>>
														<?php esc_html_e( 'Open compare bar', 'woo-smart-compare' ); ?>
                                                    </option>
                                                    <option value="show_table" <?php echo esc_attr( get_option( 'woosc_button_action', 'show_table' ) === 'show_table' ? 'selected' : '' ); ?>>
														<?php esc_html_e( 'Open compare table', 'woo-smart-compare' ); ?>
                                                    </option>
                                                    <option value="show_sidebar" <?php echo esc_attr( get_option( 'woosc_button_action', 'show_table' ) === 'show_sidebar' ? 'selected' : '' ); ?>>
														<?php esc_html_e( 'Open compare sidebar', 'woo-smart-compare' ); ?>
                                                    </option>
                                                    <option value="show_message" <?php echo esc_attr( get_option( 'woosc_button_action', 'show_table' ) === 'show_message' ? 'selected' : '' ); ?>>
														<?php esc_html_e( 'Show message', 'woo-smart-compare' ); ?>
                                                    </option>
                                                    <option value="none" <?php echo esc_attr( get_option( 'woosc_button_action', 'show_table' ) === 'none' ? 'selected' : '' ); ?>>
														<?php esc_html_e( 'Add to compare solely', 'woo-smart-compare' ); ?>
                                                    </option>
                                                </select>
                                        ...
                                        <tr class="woosc_button_action_hide woosc_button_action_show_message">
                                            ...
                                            <td>
                                                <select name="woosc_message_position">
                                                    <option value="right-top" <?php echo esc_attr( get_option( 'woosc_message_position', 'right-top' ) === 'right-top' ? 'selected' : '' ); ?>>
														<?php esc_html_e( 'right-top', 'woo-smart-compare' ); ?>
                                                    </option>
                                                    <option value="right-bottom" <?php echo esc_attr( get_option( 'woosc_message_position', 'right-top' ) === 'right-bottom' ? 'selected' : '' ); ?>>
														<?php esc_html_e( 'right-bottom', 'woo-smart-compare' ); ?>
                                                    </option>
                                                    <option value="fluid-top" <?php echo esc_attr( get_option( 'woosc_message_position', 'right-top' ) === 'fluid-top' ? 'selected' : '' ); ?>>
														<?php esc_html_e( 'center-top', 'woo-smart-compare' ); ?>
                                                    </option>
                                                    <option value="fluid-bottom" <?php echo esc_attr( get_option( 'woosc_message_position', 'right-top' ) === 'fluid-bottom' ? 'selected' : '' ); ?>>
														<?php esc_html_e( 'center-bottom', 'woo-smart-compare' ); ?>
                                                    </option>
                                                    <option value="left-top" <?php echo esc_attr( get_option( 'woosc_message_position', 'right-top' ) === 'left-top' ? 'selected' : '' ); ?>>
														<?php esc_html_e( 'left-top', 'woo-smart-compare' ); ?>
                                                    </option>
                                                    <option value="left-bottom" <?php echo esc_attr( get_option( 'woosc_message_position', 'right-top' ) === 'left-bottom' ? 'selected' : '' ); ?>>
														<?php esc_html_e( 'left-bottom', 'woo-smart-compare' ); ?>
                                                    </option>
                                                </select>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <span class="description"><?php esc_html_e( 'Change the button text after adding to the compare. If not, only add the CSS class name \'woosc-added\'.', 'woo-smart-compare' ); ?></span>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr class="heading">
                                            <th>
												<?php esc_html_e( 'Compare sidebar', 'woo-smart-compare' ); ?>
                                            </th>
                                            <td></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <select name="woosc_sidebar_position">
                                                    <option value="right" <?php echo esc_attr( get_option( 'woosc_sidebar_position', 'right' ) === 'right' ? 'selected' : '' ); ?>>
														<?php esc_html_e( 'Right', 'woo-smart-compare' ); ?>
                                                    </option>
                                                    <option value="left" <?php echo esc_attr( get_option( 'woosc_sidebar_position', 'right' ) === 'left' ? 'selected' : '' ); ?>>
                                            ...
                                            <td>
                                                <select name="woosc_menu_action">
                                                    <option value="open_page" <?php echo esc_attr( get_option( 'woosc_menu_action', 'open_popup' ) === 'open_page' ? 'selected' : '' ); ?>>
														<?php esc_html_e( 'Open compare page', 'woo-smart-compare' ); ?>
                                                    </option>
                                                    <option value="open_popup" <?php echo esc_attr( get_option( 'woosc_menu_action', 'open_popup' ) === 'open_popup' ? 'selected' : '' ); ?>>
														<?php esc_html_e( 'Open compare table', 'woo-smart-compare' ); ?>
                                                    </option>
                                                    <option value="open_sidebar" <?php echo esc_attr( get_option( 'woosc_menu_action', 'open_popup' ) === 'open_sidebar' ? 'selected' : '' ); ?>>
														<?php esc_html_e( 'Open compare sidebar', 'woo-smart-compare' ); ?>
                                                    </option>
                                                </select>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <p class="description"><?php esc_html_e( 'The class or id of the menu, when clicking on this menu the compare page or compare table will be opened.', 'woo-smart-compare' ); ?></p>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <select name="woosc_open_button_action">
                                                    ...
                                                    <option value="open_sidebar" <?php echo esc_attr( get_option( 'woosc_open_button_action', 'open_popup' ) === 'open_sidebar' ? 'selected' : '' ); ?>>
														<?php esc_html_e( 'Open compare sidebar', 'woo-smart-compare' ); ?>
                                                    </option>
                                                </select>
                                        ...
                                        <tr class="submit">
                                            <th colspan="2">
												<?php settings_fields( 'woosc_settings' ); ?>
												<?php submit_button(); ?>
                                            </th>
                                        </tr>
                                    </table>
							...
							<?php } elseif ( $active_tab === 'localization' ) { ?>
                                <form method="post" action="options.php">
                                    <table class="form-table">
                                        ...
                                        <tr class="heading">
                                            <th scope="row"><?php esc_html_e( 'Compare sidebar', 'woo-smart-compare' ); ?></th>
                                            <td></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr class="submit">
                                            <th colspan="2">
												<?php settings_fields( 'woosc_localization' ); ?>
												<?php submit_button(); ?>
                                            </th>
                                        </tr>
                                    </table>
				...
				function get_sidebar() {
					...
					if ( ! empty( $products ) ) {
						foreach ( $products as $product_id ) {
							...
							$sidebar .= '<div class="woosc-sidebar-item-remove"><span class="hint--right" aria-label="' . esc_attr( self::localization( 'sidebar_remove', esc_html__( 'Remove', 'woo-smart-compare' ) ) ) . '"> &times; </span></div>';
				...
				function get_table( $ajax = true ) {
					...
					if ( is_array( $products ) && ( count( $products ) > 0 ) ) {
						...
						if ( get_option( 'woosc_table_settings', 'yes' ) === 'yes' ) {
							$table .= '<th><a href="#settings" class="woosc-table-settings">' . self::localization( 'table_settings', esc_html__( 'Settings', 'woo-smart-compare' ) ) . '</a></th>';
						} else {
							$table .= '<th></th>';
						}
				...
				function shortcode( $attrs ) {
					...
					if ( $attrs['id'] ) {
						...
						if ( $attrs['type'] === 'link' ) {
							$output = '<a href="' . esc_url( '?add-to-compare=' . $attrs['id'] ) . '" class="woosc-btn woosc-btn-' . esc_attr( $attrs['id'] ) . ' ' . get_option( 'woosc_button_class' ) . '" data-id="' . esc_attr( $attrs['id'] ) . '" data-product_name="' . esc_attr( $product_name ) . '" data-product_image="' . esc_attr( $product_image ) . '">' . esc_html( $button_text ) . '</a>';
						} else {
							$output = '<button class="woosc-btn woosc-btn-' . esc_attr( $attrs['id'] ) . ' ' . get_option( 'woosc_button_class' ) . '" data-id="' . esc_attr( $attrs['id'] ) . '" data-product_name="' . esc_attr( $product_name ) . '" data-product_image="' . esc_attr( $product_image ) . '">' . esc_html( $button_text ) . '</button>';
						}
					}
				...
				function footer() {
					...
					if ( get_option( 'woosc_hide_empty', 'no' ) === 'yes' ) {
                    ...
                    <div id="woosc-area" class="<?php echo esc_attr( $class ); ?>"
                         data-bg-color="<?php echo esc_attr( apply_filters( 'woosc_bar_bg_color', get_option( 'woosc_bar_bg_color', $bar_bg_color_default ) ) ); ?>"
                         data-btn-color="<?php echo esc_attr( apply_filters( 'woosc_bar_btn_color', get_option( 'woosc_bar_btn_color', $bar_btn_color_default ) ) ); ?>">
                        <div class="woosc-inner">
                            ...
                            <div class="<?php echo esc_attr( get_option( 'woosc_bar_bubble', 'no' ) === 'yes' ? 'woosc-bar woosc-bar-bubble' : 'woosc-bar' ); ?>">
                            ...
                            <div class="<?php echo esc_attr( 'woosc-sidebar woosc-sidebar-position-' . get_option( 'woosc_sidebar_position', 'right' ) ); ?>">
